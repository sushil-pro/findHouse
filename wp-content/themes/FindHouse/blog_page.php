			...
			<div class="row">
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="for_blog feat_property">
								<div class="thumb">
									<img class="img-whp" src="<?php echo get_template_directory_uri();?>/assets/images/blog/1.jpg" alt="1.jpg">
						...
						<div class="col-lg-6">
							<div class="for_blog feat_property">
								<div class="thumb">
									<img class="img-whp" src="<?php echo get_template_directory_uri();?>/assets/images/blog/2.jpg" alt="2.jpg">
									<div class="blog_tag">Construction</div>
								</div>
								<div class="details">
									<div class="tc_content">
						...
						<div class="col-lg-6">
							<div class="for_blog feat_property">
								<div class="thumb">
									<img class="img-whp" src="<?php echo get_template_directory_uri();?>/assets/images/blog/3.jpg" alt="3.jpg">
									<div class="blog_tag">Construction</div>
								</div>
								<div class="details">
									<div class="tc_content">
						...
						<div class="col-lg-6">
							<div class="for_blog feat_property">
								<div class="thumb">
									<img class="img-whp" src="<?php echo get_template_directory_uri();?>/assets/images/blog/4.jpg" alt="4.jpg">
									<div class="blog_tag">Construction</div>
								</div>
								<div class="details">
									<div class="tc_content">
						...
						<div class="col-lg-6">
							<div class="for_blog feat_property">
								<div class="thumb">
									<img class="img-whp" src="<?php echo get_template_directory_uri();?>/assets/images/blog/5.jpg" alt="5.jpg">
									<div class="blog_tag">Construction</div>
								</div>
								<div class="details">
									<div class="tc_content">
						...
						<div class="col-lg-6">
							<div class="for_blog feat_property">
								<div class="thumb">
									<img class="img-whp" src="<?php echo get_template_directory_uri();?>/assets/images/blog/6.jpg" alt="6.jpg">
									<div class="blog_tag">Construction</div>
								</div>
								<div class="details">
									<div class="tc_content">
				...
				<div class="col-lg-4">
					...
					<div class="sidebar_feature_listing">
						...
						<div class="media">
							<img class="align-self-start mr-3" src="<?php echo get_template_directory_uri();?>/assets/images/blog/fls1.jpg" alt="fls1.jpg">
						...
						<div class="media">
							<img class="align-self-start mr-3" src="<?php echo get_template_directory_uri();?>/assets/images/blog/fls2.jpg" alt="fls2.jpg">
							<div class="media-body">
						...
						<div class="media">
							<img class="align-self-start mr-3" src="<?php echo get_template_directory_uri();?>/assets/images/blog/fls3.jpg" alt="fls3.jpg">
							<div class="media-body">
