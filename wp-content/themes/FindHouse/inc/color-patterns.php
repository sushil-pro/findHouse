...
function findhouse_custom_colors_css() {
	...
	/**
	 * Filter Find House default saturation level.
	 *
	 * @since Find House 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'findhouse_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.findhouse-front-page) .entry-title,
...
.colors-custom .findhouse-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.findhouse-front-page .panel-content .recent-posts article,
...
.colors-custom.findhouse-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Find House custom colors CSS.
	 *
	 * @since Find House 1.0
	 *
	 ...
	 */
	return apply_filters( 'findhouse_custom_colors_css', $css, $hue, $saturation );
}
